...
import 'react-slideshow-image/dist/styles.css'; // Import styles for the slideshow
import mobileDevData from './mobileDevData.json'; // Import your mobileDevData JSON
...
function MobileHome() {
  ...
  return (
    <div className="w-full p-5 m-auto justify-center h-[75vh] overflow-clip overflow-y-scroll scrollbar-hide">
      ...
      >
        {mobileDevData.projects.map((project, index) => (
          <div key={index} className="w-full p-2">
            <MobileDevbox project={project} link='mobile' />
          </div>
        ))}
      </Slide>
    </div>
